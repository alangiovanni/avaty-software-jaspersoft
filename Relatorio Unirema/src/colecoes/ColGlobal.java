...
public class ColGlobal {
	...
	public void populaGlobal(ColTempoReparo reparos) {
		for (TempoDeReparo reparo : reparos.retornaLista()) {
			...
			//Adicionando o novo Registro Global do circuito a cole��o
	...
	private int returnPorcentagemPagar(Global global) {
		...
		//Se N�o conter "SAT" na tecnologia ent�o � terrestre
		if (!(tecnologia.contains("SAT"))) {
			...
			//Disponibilidade abaixo de 95.9, retorna 90
				...
				porcentagemPagar=90;
			//SE Conter "SAT" na tecnologia ent�o � link SAT�LITE
		} else {
	...
	//Se retornar 0, ent�o houve erro. Verifique a String tecnologia ou as condi��es nos IF's
	...
	private double returnValorDesconto(Global global) {
		...
		//Esse calculo retornar� o desconto.
